          ...
          <Col size={12} md={12}>
            <TrackVisibility>
              {({ isVisible }) =>
                ...
                <div style={{ marginBottom: '30px', color: '#fff', textAlign: 'center' }}>
                  <p>📧 <strong>Email:</strong> sameea.sagee@gmail.com</p>
                  <p>📱 <strong>Phone:</strong> +92 341 2973543</p>
                  <p>💼 <strong>LinkedIn:</strong> linkedin.com/in/sameea-adnan</p>
                  <p>🐙 <strong>GitHub:</strong> github.com/Sameea-Saqee</p>
                  <p>▲ <strong>Vercel:</strong> vercel.com/sameea-saqees-projects</p>
                </div>
                <form onSubmit={handleSubmit}>
                  <Row>
                    ...
                    <Col size={12} className="px-1">
                      <textarea rows="6" value={formDetails.message} placeholder="Your Message" onChange={(e) => onFormUpdate('message', e.target.value)} required></textarea>
